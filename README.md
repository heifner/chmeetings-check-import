...
python check_to_chmeetings.py "checks.pdf" --review --contacts "people.xlsx"
python check_to_chmeetings.py "checks.pdf" --review --contacts "people.xlsx" --fund "Tithes" --date "03/08/2026"
